...
sys.path.append('.')
sys.path.append('..')
sys.path.insert(0,"/data/3D_dataset/COOP/src")
import json
import numpy as np
import torch
import mano
...
from tools.utils import makepath, to_cpu, to_tensor
from tools.utils import aa2rotmat, rotmat2aa, d62rotmat, get_relation_map_new
from tools.model_utils import parms_6D2full_addrh_pretrain, parms_6D2full_rh
...
class Tester:
    ...
    def __init__(self, cfg, cfg_contact, cfg_hand, inference=False):
        ...
        self.rhand_model = mano.load(model_path='/data/3D_dataset/smpl_related/models/mano',
                                    model_type='mano',
                                    num_pca_comps=45,
                                    use_pca=False,
        ...
        smplx_model_path = '/data/3D_dataset/smpl_related/models/smplx'
    ...
    def inference_generate_difheight(self):
        ...
        for batch_id, batch in enumerate(data):
            ...
            obj_path = obj_path.replace("/mnt/workspace/motion/grab_data", self.cfg.datasets.dataset_dir)
...
def inference():
    ...
    parser.add_argument('--data-file', default='/data/3D_dataset/GrabNet/data/GRAB/data/GNet_data',
                        type=str,
